...
// set AccountNumber property of account to be edited
...
if($account->debit()){
    ...
    // tell the user
    echo json_encode(array("message" => "Account was debited."));
}
...
// if unable to update the account, tell the user
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to debit Account."));
}
?>
